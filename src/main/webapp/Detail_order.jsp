...
<body>
<div class="bg">
    <h2 class="back_button"><a href="order.jsp"><img alt="" src="img/icon/back-button.png"></a></h2>

 <div class="cart_item_details">
 
 <div class="head"><h4>Purchased items</h4></div>
 <%
 ...
 ResultSet rs=null;
 String cid=(String)session.getAttribute("Order_id");
...
%>
         <br>  
 <div class="row"><div class="cid">Total Amount-</div> 
